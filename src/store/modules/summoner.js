...
export const summoner={
  ...
  state: () => ({
    playerDetails: [
      {
        "accountid": "1x5VRP1A3SYYCvTX2gPeGtphmY0r5gKpsQgnUaRYNwWuliA",
        "gamename": "Tester",
        "profileiconid": 5167,
        "puuid": "1KOa2cg3YQzQQTu5Aon3PJ1D1MLRSltJ00Jjm6y4xHBZpDP7P0sR2VgBV8ihyeQGMJ-b86bLM0Jj9Hg",
        "revisiondate": "11707351742533",
        "summonerid": "18VkycVXOXQxDsbmzGDjnO_mZjTa_EvTEpjXaRLeMg92qpIs",
        "summonerlevel": 457,
        "tagline": "euw1",
        "timestamp": "1707409589167"
      }      
    ],
  }),
  getters: {
    getSummonerDataByName: (state) => (summonerName) => {
      return state.playerDetails.find(detail => detail.name === summonerName) || null;
    },
  ...
  actions: {
    ...
    async fetchSummonerData({commit, state}, {region, gameName, tagLine}) {
      ...
      const existingDetail = state.playerDetails.find(detail => detail.gamename === gameName);
