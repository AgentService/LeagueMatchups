...
const debug = Debug("app:component:LearningObjectives");
export default {
	data() {
		return {
			showLOs: false,
			...
			learningObjectives: [
				...
				{ name: "Wave Management", startDate: new Date(), progress: 35, started: true, category: "In-Game", endDate: this.addWeeksToDate(new Date(), 4) },
				{ name: "Thread Assesment", startDate: new Date(), progress: 65, started: true, category: "In-Game", endDate: this.addWeeksToDate(new Date(), 4) },
				{ name: "Roaming", startDate: new Date(), progress: 95, started: true, category: "In-Game", endDate: this.addWeeksToDate(new Date(), 4) },
				{ name: "Positioning", startDate: new Date(), progress: 15, started: true, category: "In-Game", endDate: this.addWeeksToDate(new Date(), 4) },
				{ name: "Map Awareness", startDate: new Date(), progress: 25, started: true, category: "In-Game", endDate: this.addWeeksToDate(new Date(), 4) },
				...
				{ name: "Teamfights", startDate: new Date(), completed: true, progress: 22, started: true, category: "Out-of-Game", endDate: this.addWeeksToDate(new Date(), 6) },
				{ name: "Teamfights", startDate: new Date(), completed: true, progress: 66, started: true, category: "Out-of-Game", endDate: this.addWeeksToDate(new Date(), 6) },
